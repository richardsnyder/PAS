...
IF %DebugFlag% EQU 0 (
  call .\etlclient -p "[04-03]-PAS-FINANCIALS [Retail Sales Daily] Store Update and Data Load" -j "01-00 Nightly - Retail Sales Daily  Cube Load" -c Forecast_MMM=%FcastVer%  >>%LogFileName%
)
